To run this app, first tap Yarn in main project folder, then run yarn start to open expo cli. If get some errors from Expo CLI, please read this document: https://docs.expo.io/workflow/expo-cli/ .
